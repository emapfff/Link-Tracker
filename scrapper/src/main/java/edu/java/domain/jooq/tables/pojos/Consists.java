...
public class Consists implements Serializable {
    ...
    public Consists(Consists value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final Consists other = (Consists) obj;
        if (this.chatId == null) {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("Consists (");
